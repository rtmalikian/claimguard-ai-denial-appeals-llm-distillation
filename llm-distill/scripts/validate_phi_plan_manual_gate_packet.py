...
STUDENT_CUTOVER_PRIVATE_ENV_RENDERER_REQUIRED_MARKERS = [
    ...
    "CLAIMGUARD_STUDENT_CUTOVER_PRIVATE_SUMMARY_PATH",
    "_validate_private_cutover_summary",
    ...
    "supervisor evidence report is not ready",
    "supervisor_report_checked",
    "supervisor_report_ready",
    "private_cutover_summary_checked",
    "private_cutover_summary_path_value_included",
    ...
    "private_cutover_summary_raw_values_included",
    "unsupported fields",
...
MANUAL_GATE_PRIVATE_PACKET_RENDERER_REQUIRED_MARKERS = [
    ...
    "manual gate dependent report is not ready",
    "dependent_evidence_reports_checked",
    "dependent_evidence_reports_ready",
    "private_manual_gate_summary_checked",
...
def student_cutover_requirement(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    required_flags = {
        ...
        "source_control_runtime_supervisor_private_evidence_renderer_documented": "runtime_supervisor_private_evidence_renderer_not_documented",
...
def production_corpus_requirement(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    for key, blocker in {
        ...
        "source_control_private_evidence_renderer_documented": "production_corpus_private_evidence_renderer_not_documented",
    ...
    return requirement(
        ...
        evidence={
            ...
            "source_control_private_evidence_renderer_documented": bool_value(section, "source_control_private_evidence_renderer_documented"),
...
def retrieval_vector_backend_requirement(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    required_flags = {
        ...
        "source_control_private_env_renderer_documented": "retrieval_private_env_renderer_not_documented",
...
def prediction_fairness_monitoring_requirement(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    required_flags = {
        ...
        "source_control_private_evidence_renderer_documented": "prediction_fairness_private_evidence_renderer_not_documented",
