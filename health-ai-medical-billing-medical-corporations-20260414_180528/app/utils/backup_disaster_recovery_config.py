...
def validate_backup_disaster_recovery_startup_config(
    *,
    settings_like=None,
    ...
    report_ready = (
        evidence_report.get("backup_disaster_recovery_ready") is True
    ...
    if not evidence_report_configured:
        blockers.append("backup_disaster_recovery_evidence_report_path_missing")
    elif not evidence_report_checked:
        blockers.append("backup_disaster_recovery_evidence_report_unavailable")
    ...
    if blocked_requirement_ids:
        blockers.append("backup_disaster_recovery_evidence_report_has_blocked_requirements")

    safe_context = {
        "evidence_report_path_included": False,
        "raw_evidence_report_included": False,
        "raw_backup_path_included": False,
        "raw_backup_artifact_included": False,
        "raw_restore_output_included": False,
        "raw_database_rows_included": False,
        "raw_encryption_key_value_included": False,
    ...
    if blockers:
        logger.warning(
            "backup_disaster_recovery_startup_config_validation_failed",
            extra={"backup_disaster_recovery_startup_config": log_payload},
        )
    else:
        logger.info(
            "backup_disaster_recovery_startup_config_validation_passed",
            extra={"backup_disaster_recovery_startup_config": log_payload},
        )
