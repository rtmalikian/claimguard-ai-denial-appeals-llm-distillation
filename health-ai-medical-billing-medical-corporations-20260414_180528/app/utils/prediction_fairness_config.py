...
def validate_prediction_fairness_startup_config(
    *,
    settings_like=None,
    ...
    report_ready = (
        evidence_report.get("prediction_fairness_monitoring_ready") is True
    ...
    if not evidence_report_configured:
        blockers.append("prediction_fairness_evidence_report_path_missing")
    elif not evidence_report_checked:
        blockers.append("prediction_fairness_evidence_report_unavailable")
    ...
    if blocked_requirement_ids:
        blockers.append("prediction_fairness_evidence_report_has_blocked_requirements")
    ...
    if blockers:
        logger.warning(
            "prediction_fairness_startup_config_validation_failed",
            extra={"prediction_fairness_startup_config": log_payload},
        )
    else:
        logger.info(
            "prediction_fairness_startup_config_validation_passed",
            extra={"prediction_fairness_startup_config": log_payload},
        )
