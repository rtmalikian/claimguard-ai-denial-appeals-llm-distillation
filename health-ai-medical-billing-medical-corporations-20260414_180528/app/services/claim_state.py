...
CLAIM_STATUS_SCRUBBING = "scrubbing"
...
CLAIM_STATUS_APPEAL_APPROVED = "appeal_approved"
CLAIM_STATUS_APPEAL_DENIED = "appeal_denied"
CLAIM_STATUS_PAID = "paid"
CLAIM_STATUS_PARTIALLY_PAID = "partially_paid"
CLAIM_STATUS_WRITE_OFF = "write_off"
CLAIM_STATUS_TIMELY_FILING = "timely_filing"

CANONICAL_CLAIM_STATUSES = (
    CLAIM_STATUS_DRAFT,
    CLAIM_STATUS_PENDING,
    CLAIM_STATUS_SCRUBBING,
    CLAIM_STATUS_SUBMITTED,
    CLAIM_STATUS_ACCEPTED,
    CLAIM_STATUS_IN_REVIEW,
    CLAIM_STATUS_DENIED,
    CLAIM_STATUS_APPEALED,
    CLAIM_STATUS_APPEAL_APPROVED,
    CLAIM_STATUS_APPEAL_DENIED,
    CLAIM_STATUS_PAID,
    CLAIM_STATUS_PARTIALLY_PAID,
    CLAIM_STATUS_WRITE_OFF,
    CLAIM_STATUS_TIMELY_FILING,
)
